...
function vcb_i18n_map(): array {
	return array(
		...
		'Khoảng cách mép'       => 'Edge spacing',
		'Cạnh dưới'             => 'Bottom',
		'Cạnh bên (phải/trái)'  => 'Side (right/left)',
		'Tăng lên để né nút "cuộn lên đầu trang" hoặc widget khác. Mặc định 24. Cạnh bên không áp dụng khi chọn "Dưới giữa".' => 'Increase to clear a "scroll to top" button or other widgets. Default 24. Side spacing does not apply when "Bottom center" is selected.',
